...
func systemProjectName() -> String {
    return "ClickConsultasMobileIOS"
}
...
let template = Template(
    description: "Template para criar um novo módulo com TCA",
    attributes: [
        nameAttribute,
        authorAttribute,
        dateAttribute,
    ...
    items: [
        .file(
            path: "Modules/\(nameAttribute)/\(nameAttribute).swift",
            templatePath: "Sources/Feature.stencil"
        ),
        .file(
            path: "Modules/\(nameAttribute)/\(nameAttribute)+Feature.swift",
            templatePath: "Sources/Controller.stencil"
        ),
        .file(
            path: "Modules/\(nameAttribute)/\(nameAttribute)+View.swift",
            templatePath: "Sources/View.stencil"
        ),
    ]
)
